namespace kyrsovaya
{
    partial class Form_consult_PSM
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_consult_PSM));
            ...
            this.label2.Text = "Научные интересы: аналого-цифровое преобразование, избыточные алгоритмы АЦП, цифр" +
    "овые фильтры, инструментальные средства разработки мультимедиа, технологии подго" +
    "товки мультимедийных изданий.";
            // 
            // Form_consult_PSM
            // 
